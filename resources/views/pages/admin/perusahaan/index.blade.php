...
@include('pages.admin.perusahaan.create')

<div class="d-flex flex-column p-4 flex-fill">
    <h3 class='mb-3 text-secondary fw-semibold'>Perusahaan</h3>
    <div class="bg-white shadow-sm rounded-2 border flex-fill overflow-auto p-4">
        <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#addPerusahaanModal">
            <i class="bi bi-plus text-white h5"></i>
            Tambah Data
        </button>
        <a class="btn btn-success mb-3" href="{{route('api.admin.perusahaan.export')}}">
            <i class="bi bi-table text-white"></i>
            &nbsp;Export Excel
        </a>

        @include('pages.admin.perusahaan.show')
